...
<body class="hold-transition login-page" style="background-image: url('https://wallpapercave.com/wp/wp2896963.jpg')">
<div class="login-box">
  <div class="card">
    ...
    <form action="{{ route('handle-register') }}" method="POST">
        ...
        <p class="mb-1 mt-2">
           <a href="{{ route('login-admin') }}"> <button type="submit" class="btn btn-success btn-block">Đăng nhập</button></a>
        </p>
    </div>
    <!-- /.login-card-body -->
  </div>
