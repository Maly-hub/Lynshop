...
@section('content')
<h3 style="text-align: center">Trang thanh toán</h3>
    <div class="row">
        <div class="col-12 text-center">
            <h5>Thông tin sản phẩm</h5>
            <p style="color: red; text-align: center">Vui lòng kiểm tra lại giỏ hàng</p>
        </div>
    </div>
        <div class="row">
            <div class="col-1"></div>
            <div class="col-md-10">
                ...
                <form method="POST" action="{{ route('dat-hang') }}">
                    ...
                    <div class="form-group">
                        <a href="{{ route('capnhat-soluong') }}"><button type="submit" class="btn btn-success">Đặt hàng</button></a>
                    </div>
                </form>
            </div>
            <div class="col-1"></div>
